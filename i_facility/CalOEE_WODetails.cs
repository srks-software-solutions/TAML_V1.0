...
namespace i_facility
{
    ...
    {
        private i_facility_tamlEntities db = new i_facility_tamlEntities();
                ...
                foreach (var macrow in machineData)
                {
                    ...
                    try
                    {
                        ...
                        if (OEEDataPresent.Count == 0)
                        {
                            ...
                            using (i_facility_tamlEntities dbLoss = new i_facility_tamlEntities())
                            {
                                    ...
                                    if (duration > 0)
                                    {
                                        ...
                                        if (level == 3)
                                        {
                                            ...
                                            using (MsqlConnection mcInsertRows = new MsqlConnection())
                                            {
                                                ...
                                                {
                                                    mcInsertRows.open();
                                                    SqlCommand cmdInsertRows = new SqlCommand("INSERT INTO i_facility_taml.dbo.tblwolossess "
