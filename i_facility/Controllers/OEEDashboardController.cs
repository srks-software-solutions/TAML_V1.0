                    ...
                    if (OEEDataSummarizedToView != null)
                    {
                        ...
                        if (TimingVar != "Today")
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                     "(" +
                                                     "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables a where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariables b where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables c where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables d where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables e where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                        ...
                        else
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                     "(" +
                                                     "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday a where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday b where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday c where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday d where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday e where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     ") f order by f.lossname desc";
                        }
                ...
                if (lowestLevel == "Shop")
                {
                    ...
                    if (OEEDataSummarizedToViewShop != null)
                    {
                        ...
                        if (TimingVar != "Today")
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                 "(" +
                                                 "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables a where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariables b where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables c where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables d where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables e where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 ") f order by f.lossname desc";
                        }
                        else
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                "(" +
                                                "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday a where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday b where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday c where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday d where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday e where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                ") f order by f.lossname desc";
                        }
                        DataTable GetDistinctLossDT = new DataTable();
                        using (MsqlConnection mc = new MsqlConnection())
        ...
        public void CalculateSummarizedOEEPlant(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var PlantRow in getPlant)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday a where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday b where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday c where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday d where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday e where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
                    ...
                    for (int i = 0; i < LossCount; i++)
                    {
                        ...
                        String GetLossDurationQuery = "Select SUM(Total) From " +
                                       "(Select SUM(Loss1Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariablestoday " +
                                       ...
                                       "Union all " +
                                       "Select SUM(Loss2Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariablestoday  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss3Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariablestoday  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss4Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariablestoday  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss5Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariablestoday " +
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var PlantRow in getPlant)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables a where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariables b where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables c where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables d where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables e where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
                    ...
                    for (int i = 0; i < LossCount; i++)
                    {
                        ...
                        DataTable GetLossDurationDT = new DataTable();
                        String GetLossDurationQuery = "Select SUM(Total) From " +
                                       "(Select SUM(Loss1Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariables " +
                                       ...
                                       "Union all " +
                                       "Select SUM(Loss2Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariables  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss3Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariables  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss4Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariables  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss5Value)  as Total From i_facility_taml.dbo.tbloeedashboardvariables " +
        ...
        public void CalculateSummarizedOEEShop(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var ShopRow in getShop)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday a where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday b where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday c where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday d where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday e where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var Row in getShop)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables a where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariables b where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables c where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables d where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables e where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
        ...
        public void CalculateSummarizedOEECell(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var CellRow in getCell)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday a where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday b where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday c where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday d where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday e where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var Row in getCell)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables a where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariables b where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables c where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables d where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables e where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
        ...
        public void CalculateSummarizedOEEWC(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var WCRow in getWC)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday a where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday b where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "'  and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday c where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "'  and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday d where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "'  and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariablestoday e where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "'  and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var WCRow in getWC)
                {
                    ...
                    /*     string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                  "(" +
                                                  "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables a where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  "Union All " +
                                                  "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariables b where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  "Union All " +
                                                  "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables c where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  "Union All " +
                                                  "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables d where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  "Union All " +
                                                  "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables e where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  ") f order by f.lossname desc";*/
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables a where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_taml.dbo.tbloeedashboardvariables b where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables c where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables d where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_taml.dbo.tbloeedashboardvariables e where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    MsqlConnection mc = new MsqlConnection();
                    mc.open();
                    SqlDataAdapter GetDistinctLossDA = new SqlDataAdapter(GetDistinctLossQuery, mc.msqlConnection);
