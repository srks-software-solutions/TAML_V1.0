...
namespace i_facility.Controllers
{
    public class HMIScreeController : Controller
    {
                ...
                foreach (var plan in tbldaily_plan)
                {
                    ...
                    if (hmiid != ExceptionHMIID)
                    {
                        ...
                        if (hmiidData != null)
                        {
                            ...
                            //2017-01-21
                            //using (i_facility.Models.i_facility_tamlEntities dbHMI = new i_facility.Models.i_facility_tamlEntities())
                            //{
        ...
        public ActionResult OverAllFinish(string HMIIDs)
        {
            ...
            {
                //using (i_facility_tamlEntities dbsimilar = new i_facility_tamlEntities())
                //{
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //using (i_facility_tamlEntities dbhmi = new i_facility_tamlEntities())
            //{
            try
            {
        ...
        public ActionResult DDLList(int DDLID = 0, string MacInvNo = null, int ToHMI = 0)
        {
            ...
            if (DDLID != 0)
            {
                ...
                obj.UpdateLiveHMIScreenDetails6(ddldata.OperationNo, ddldata.MaterialDesc, ddldata.Project, Target_Qty, TotalProcessQty, Type, ddldata.WorkOrder, Hmiid1, ddldata.WorkCenter);
        ...
        List<string> GetHierarchyData(int MachineID)
        {
            ...
            //using (i_facility_tamlEntities dbMac = new i_facility_tamlEntities())
            //{
            var machineData = obj.GetMachineDetails(MachineID);
            int PlantID = Convert.ToInt32(machineData.PlantID);
            string name = "-";
